...
import Proposed_Data_complexity_aware_RideNN_ensemble_classifier.RidderOptimization
...
def Classify(Data,Label,tr):
    ...
    Proposed_Data_complexity_aware_RideNN_ensemble_classifier.RidderOptimization.Algm()
